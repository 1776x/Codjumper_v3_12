...
init()
{
	...
	{
		for ( rId = 0; rId <= level.maxRank + 2; rId++ ) //+2 for admins.
...
//		/// logString
//		setLog("RankXp: " + player.pers["rankxp"]);
//		setLog("Rank: " + player.pers["rank"]);
//		setLog("MinXp: " + player getRankInfoMinXP(rankid));
//		setLog("MaxXp: " + player getRankInfoMaxXp(rankid));
//		setLog("Stat251: " + player getStat(251));
...
updateRankScoreHUD( amount )
{
	...
	if( isDefined( self.hud_rankscroreupdate ) )
	{
		...
		self.hud_rankscroreupdate.alpha = 0; // 0.85
